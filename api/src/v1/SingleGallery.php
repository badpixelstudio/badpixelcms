...
require_once("../../include/singlegallery/singlegallery.ws.php");

/**
 * @uri /images/list
 * @uri /images/list/:offset
 * @uri /images/list/:offset/:page  
 */
class SingleGalleryList extends Resource
{
    /**
     * @method GET
     ...
     */
    public function SingleGalleryList($day='') {
		$offset="";
		$page="";
		if (isset($this->params['offset'])) { $offset=$this->params['offset']; }
		if (isset($this->params['page'])) { $page=$this->params['page']; }			
		$ws=new \ws_singlegallery($_GET);
		$salida=$ws->wsSingleGalleryList($page,$offset);
 ...
 * @uri /images/view/:id
 */
class SingleGalleryView extends Resource
{
    /**
     * @method GET
     * @provides application/json
     ...
     * @return Tonic\Response
     */
    public function SingleGalleryView($id='') {
		$ws=new  \ws_singlegallery($_GET);
		$salida=$ws->wsSingleGalleryView($id);
		return new Response(200, $salida);
    }
