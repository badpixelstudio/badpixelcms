function GeographyChanger(elemento) {
	...
	$('#'+volcar_en).load("lib/geography/load.php?element=" +  encodeURIComponent(elemento_form) +"&table=" + encodeURIComponent(tabla) +"&id=" + encodeURIComponent(Valor) + "&value=" + encodeURIComponent(ValorActual),function() {
		if (idelemento=='Form_IDState') {
