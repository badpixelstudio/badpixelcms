CREATE TABLE IF NOT EXISTS `singleblog` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
  `IDBusiness` bigint(20) DEFAULT '0',
  `IDCategory` BIGINT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `singleblog_attachments` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `singleblog_comments` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
  `IDFather` bigint(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `singleblog_images` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
  `IDFather` bigint(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `singleblog_links` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
  `IDFather` bigint(20) DEFAULT NULL,
  `Link` varchar(250) DEFAULT NULL,
  `Description` varchar(250) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `singleblog_translations` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `singleblog_videos` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT,
  `IDFather` bigint(20) DEFAULT NULL,
  `Embed` mediumtext,
  `Description` varchar(250) DEFAULT NULL,
...
(NULL, 'blog', '', '0', 'singleblog', 'action=list', NULL, NULL, NULL, '0');